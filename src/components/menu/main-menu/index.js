...
const tlink = [
    ...
    {"title": "Лінії інспекції",
    "link": "/ua/комплексні-рішення/лінія-оптичної-інспекції"
    },
    {"title": "Материалы для пайки",
    "link": "/материалы-для-smt/паяльная-паста-и-припой"
    },
    {"title": "Жидкости для отмывки",
    "link": "/материалы-для-smt/жидкости-для-мойки"
    },
    {"title": "Защитные покрытия",
    "link": "/материалы-для-smt/защитные-покрытия"
    },
    {"title": "Матеріали для паяння",
    "link": "/ua/матеріали-для-smt/матеріали-для-паяння"
    },
    {"title": "Захисні покриття",
    "link": "/ua/матеріали-для-smt/захисні-покриття"
    },
    {"title": "Рідини для чищення",
    "link": "/ua/матеріали-для-smt/рідини-для-чищення"
    }
]
