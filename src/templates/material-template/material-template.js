...
import Machines from '../../containers/materials/material'
...
import Tab from '../../containers/elements/tabs/tab-material'
...
const CaseStudyTemplate = ({ data, pageContext: { next, previous }, location, ...restProps }) => {
    const pageData = data.materialJson;
    let bannerImg;
...
export const query = graphql`
    query($slug: String!){
        materialJson(fields: {slug: {eq: $slug}}){
            id
            title
            bigtitle
            ru
