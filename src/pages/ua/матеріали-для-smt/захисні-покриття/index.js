...
const IndexPage = ({location}) => (
  <Layout location={location}>
    <SEO title="Захисні покриття" description="Захисні покриття для нанесення на плати. Застосовуються для захисту друкованих плат від впливу навколишнього середовища, хімічних речовин і температури" pathname="ua/матеріали-для-smt/захисні-покриття" keywords="захисні покриття, лак для друкованих плат, захист електроніки, акрилові покриття, силіконовий лак, ур-63, уретанове покриття, humiseal, лакування плат" lang="ua" />
    <Header/>
