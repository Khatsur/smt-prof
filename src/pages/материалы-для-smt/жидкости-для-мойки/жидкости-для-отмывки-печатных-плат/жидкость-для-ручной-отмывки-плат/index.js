...
const title = "Жидкость для ручной отмывки плат";
const language = "ru";
const path =
  "материалы-для-smt/жидкости-для-мойки/жидкости-для-отмывки-печатных-плат/жидкость-для-ручной-отмывки-плат";
const CaseStudiesPage = ({ pageContext, location }) => (
  <Layout location={location}>
    <SEO
      title={title}
      description="Жидкость для ручной отмывки плат после загрязнений возникающих в процессе монтажа электронных компонентов на поверхность и в отверстия печатных плат"
      pathname={path}
