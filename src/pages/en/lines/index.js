...
const Materials = ({ location, pageFromCMS }) => (
  <Layout location={location}>
    ...
    <SEO title="Complete solutions for electronics manufacturing" description="Complete solutions for electronics manufacturing. Solution for small electronics production and prototyping. Solutions for serial and mass production" pathname="en/lines" keywords="smt line, smt line, smd assembly equipment, surface mount line, surface mount line, smd assembly line, complete solutions for electronics manufacturing, g-titan, juki rs-1" lang="en"/>
    <Header transparent  />
