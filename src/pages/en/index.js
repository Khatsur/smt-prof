...
const IndexPage = ({location}) => (
  <Layout location={location}>
    <SEO title="Machines for SMT" description="SMT PROF - machines for surface mounting, equipment for SMT, SMT PROF - the first Ukrainian project to equip production of printed circuit boards assembly, machines for SMT" pathname="smt-prof"/>
    <Header transparent/>
