...
const IndexPage = ({location}) => (
  <Layout location={location}>
    <SEO title="Оборудование для мойки" description="Оборудование для мойки собранных печатных плат, трафаретов для нанесения паяльной пасты, технологической оснастки для пайки (паллеты) и частей оборудования" pathname="оборудование-для-монтажа/оборудование-для-мойки" keywords="оборудование для мойки, оборудование для мойки плат, оборудование для мойки трафаретов, оборудование для мойки паллет, очистка трафаретов, мойка плат, smt, мойка плат, мойка трафаретов" lang="ru"/>
    <Header/>
