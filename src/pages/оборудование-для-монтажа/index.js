...
const IndexServices = ({ location, pageFromCMS }) => (
  <Layout location={location}>
    ...
    <SEO title="Оборудование для монтажа" description="SMT PROF- оборудование для поверхностного монтажа, оборудование для SMT, SMT PROF – первый украинский проект по оснащению производств монтажа печатных плат" pathname="оборудование-для-монтажа" />
    <Header transparent  />
