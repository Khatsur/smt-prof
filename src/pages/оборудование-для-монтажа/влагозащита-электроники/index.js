...
const IndexPage = ({location}) => (
  <Layout location={location}>
    <SEO title="Влагозащита электроники" description="Влагозащита электроники. Оборудование для нанесения покрытий на электронные блоки. Селективное нанесения защитных материалов. Нанесение лака погружением" pathname="оборудование-для-монтажа/влагозащита-электроники" keywords="влагозащита электроники, оборудование для селективного нанесения, селективная влагозащита, нанесения защитных покрытий, нанесение лака, лакировка плат, smt" lang="ru"/>
    <Header/>
