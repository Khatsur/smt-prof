...
import LaserPageHeader from '../../../../components/pageheader/cutting-laser'
import Laser from '../../../../containers/machines/cutting/laser'
import ContactArea from '../../../../containers/global/contact-area/contact-three-ru'
import MachinesCutting from '../../../../containers/machines/cutting'



const title = "Разделение групповых заготовок лазером";
const language = "ru";
const path = "оборудование-для-монтажа/разделение-групповых-заготовок/разделение-групповых-заготовок-лазером";
const CaseStudiesPage = ({ pageContext, location }) => (
  <Layout location={location}>
    ...
    <main className="site-wrapper-reveal">
        <Laser path={path} language={language}/>
        <ContactArea />
        <MachinesCutting />
    </main>
    <Footer/>
