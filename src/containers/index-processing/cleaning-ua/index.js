...
const HeroArea = (props) => {
    const HeroData = useStaticQuery(graphql`
        query CleaningHeroQueryUa {
            indexProcessingJson(id: {eq: "cleaning-hero-content-machine"}) {
                uatitle
                uasubtitle
                uatext
                link
    ...
    const { uatitle, uasubtitle, uatext, link, video_link, bg_image, image } = HeroData.indexProcessingJson;
                    ...
                    <Row alignitems="center">
                        <Col lg={8} md={7}>
                            <HeroTextBox>
                                ...
                                {uatitle && <Heading {...titleStyle}>{parse(uatitle)}</Heading>}
