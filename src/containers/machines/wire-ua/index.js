    ...
    const boxContents = [
        {
            id: 1,
            imageSrc: image1,
            title: 'Різання проводу і кабелю',
        ...
        },
        {
            id: 2,
            imageSrc: image2,
            title: 'Чищення проводу і кабелю',
        ...
        },
        {
            id: 3,
            imageSrc: image3,
            title: 'Обтискання  терміналів ',
            desc: 'Обладнання для пресування контактів. Автоматичне і  напів-автоматичне обладнання для кремпування контактів.',
            path: '/machines/smt'
        }
    ]
