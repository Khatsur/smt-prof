    ...
    return (
        <SectionWrap>
            <Container>
                ...
                <h6 style={{textAlign: "justify"}}>Монтаж електронних компонентів в отвори друкованих плат (THT) - це класична технологія монтажу електронних компонентів, яка активно застосовується до сьогоднішнього часу. Монтаж в отвори має два основних технологічних процесів. Встановлення електронних компонентів в отвори друкованих плат. Для автоматизації процесів встановлення компонентів застосовуються спеціальні автоматичні машини. Групова пайка на машині пайки хвилею припою або селективна пайка на автоматичній машині для селективного паяння.</h6>
