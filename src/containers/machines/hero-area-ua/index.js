...
const HeroArea = (props) => {
    ...
    `);
    const {uatitle, uatitle_tht, uatitle_clean, uatitle_coating, uatitle_aoi, uasubtitle, uatext, bg_image, bg_image2, bg_image3, bg_image4, bg_image5, link, linktht, ualinktht, linkcleaning, ualinkcleaning, linkcoating, ualinkcoating, ualinkinspection, ualink, video_link} = heroData.indexResolutionsJson;
                    ...
                    <Row>
                        <Col lg={12}>
                            <HeroContent>
                                ...
                                <HeroBtnGroup>
                                    {link && <Button {...btnStyle} {...consult_btn} to={`/ua${ualink}`}>Докладно...</Button>}
                    ...
                    <Row>
                        <Col lg={12}>
                            <HeroContent>
                                ...
                                {uatext && <Text {...textStyle}>{uatext}</Text>}
                                <HeroBtnGroup>
                                    {link && <Button {...btnStyle} {...consult_btn} to={`/ua${ualinktht}`}>Докладно...</Button>}
                ...
                <Container>
                    <Row>
                        <Col lg={12}>
                            <HeroContent>
                                {uasubtitle && <Heading {...subtitleStyle}>{uasubtitle}</Heading>}
                                {uatitle && <Heading {...titleStyle}>{uatitle_clean}</Heading>}
                                {uatext && <Text {...textStyle}>{uatext}</Text>}
                                <HeroBtnGroup>
                                    {link && <Button {...btnStyle} {...consult_btn} to={`/ua${ualinkcleaning}`}>Докладно...</Button>}
                    ...
                    <Row>
                        <Col lg={12}>
                            <HeroContent>
                                ...
                                {uatext && <Text {...textStyle}>{uatext}</Text>}
                                <HeroBtnGroup>
                                    {link && <Button {...btnStyle} {...consult_btn} to={`/ua${ualinkcoating}`}>Докладно...</Button>}
                ...
                <Container>
                    <Row>
                        <Col lg={12}>
                            <HeroContent>
                                {uasubtitle && <Heading {...subtitleStyle}>{uasubtitle}</Heading>}
                                {uatitle && <Heading {...titleStyle}>{uatitle_aoi}</Heading>}
                                {uatext && <Text {...textStyle}>{uatext}</Text>}
                                <HeroBtnGroup>
                                    {link && <Button {...btnStyle} {...consult_btn} to={`/ua${ualinkinspection}`}>Докладно...</Button>}
