...
const CaseStudiesArea = (props) => {
    const autoPrinterData = useStaticQuery(graphql `
        query {
            allToptablePlacerJson (sort: {order: ASC, fields: id}) {
                edges {
                    node {
                        fields{
                            slug
            ...
            allToptablePlacerUaJson (sort: {order: ASC, fields: id}) {
                edges {
                    node {
                        fields{
                            slug
    ...
    const caseStudies = autoPrinterData.allToptablePlacerJson.edges;
    const caseStudiesUa = autoPrinterData.allToptablePlacerUaJson.edges;
    const brochure = "";
    ...
    {return (
        <Section {...sectionStyle}>
            <Row>
                <Col>
                    <Heading {...headingStyle}>Настольные автоматические расстановщики SMD</Heading>
    ...
    return (
        <Section {...sectionStyle}>
            <Row>
                <Col>
                    <Heading {...headingStyle}>Настільні автоматичні розстановники SMD</Heading>
