...
const TimelineArea = (props) => {
    const content = [
        ...
        },
        {
            ...
            desc: "Оборудование для поверхностного монтажа. Для нанесения паяльной пасты на печатные платы через трафарет в полу автоматическом режиме. Программирование технологических параметров: скорость движения ракелей, давление ракелей, скрость разделения и др. Автоматическое совмещение трафарета и платы. Применяется для мелкосерийного и серийного производства поверхностного монтажа плат (SMT) как отдельностоящее оборудование.",
        ...
        return (
            <SectionWrap>
                <Container>
                    <Row>
                    <Col lg={12}>
                           <h6 style={{textAlign: "justify"}}>Принтер.</h6>
                        </Col>
                        <Col lg={12}>
