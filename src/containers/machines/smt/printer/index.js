...
const TimelineArea = (props) => {
    const content = [
        ...
        },
        {
            ...
            path: "/оборудование-для-монтажа/поверхностный-монтаж/принтеры-паяльной-пасты/полуавтоматический-трафаретный-принтер",
            lang: "Подробно..."
        },
        {
            year: "РУЧНЫЕ",
    ...
    const contentua = [
        ...
        },
        {
            ...
            path: "/ua/обладнання-для-монтажу/поверхневий-монтаж/принтери-паяльної-пасти/напівавтоматичний-трафаретний-принтер",
            lang: "Докладно..."
        },
        {
            year: "РУЧНІ",
