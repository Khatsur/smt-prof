...
const TimelineArea = (props) => {
    const content = [
        ...
        },
        {
            ...
            path: "/оборудование-для-монтажа/поверхностный-монтаж/автоматическая-оптическая-инспекция/оптическая-инспекция-печатных-плат",
            lang: "Подробно..."
        }
    ]
    const contentua = [
        ...
        },
        {
            ...
            path: "/ua/обладнання-для-монтажу/поверхневий-монтаж/автоматична-оптична-інспекція/оптична-інспекція-друкованих-плат",
            lang: "Докладно..."
        }
    ]
    if (props.lang === "ru") {
