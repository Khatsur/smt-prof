...
const CaseStudySection = ({
    ...
    query BudStencilCleanEn {
        indexAppointmentJson(id: {eq: "budget-stencil-cleaning"}) {
          id
          entitle
          ensubtitle
          entext
    ...
    const caseStudies = caseStudyData.allBudStencCleanJson.edges;
            ...
            <Container>
                <Row>
                    <Col lg={12}>
                        <SectionTitle
                            {...sectionTitleStyle}
                            title={caseStudySecData.entitle}
                            subtitle={caseStudySecData.ensubtitle}
                        />
                        <div style={{fontSize: 16}}>{caseStudySecData.entext}</div><br></br>
                            ...
                            {caseStudies.map(caseStudy => (
                                <div className="item" key={caseStudy.node.id}>
                                    <CaseStudyBox
                                        ...
                                        title={caseStudy.node.entitle}
                                        category={caseStudy.node.category}
                                        desc={caseStudy.node.enexcerpt}
