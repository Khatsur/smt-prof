        ...
        <Section {...sectionStyle}>
            <Row>
                ...
                <br></br>
                    ...
                    <h6 style={{textAlign: "justify"}}>
                    Бюджетная серия шкафы сухого хранения объемом камеры до 900 л. Применяются для увеличения срока хранения электронных компонентов и печатных плат. Оборудование обеспечивает поддержание относительной влажности 0,5- 50%RH. Для длительного хранения рекомендуется применять азотную (N2) среду. Оборудование обеспечивает восстановление влажности внутри камеры за короткое время. Дополнительно оборудование может дооснащаться системой сушки для устранения влаги в корпусах электронных компонентов.</h6>
