...
const HeroArea = (props) => {
    ...
    `);
    const {entitle, entitle_tht, entitle_clean, entitle_coating, entitle_aoi, ensubtitle, entext, bg_image, bg_image2, bg_image3, bg_image4, bg_image5, link, video_link} = heroData.indexResolutionsJson;
                    ...
                    <Row>
                        <Col lg={12}>
                            <HeroContent>
                                ...
                                {entext && <Text {...textStyle}>{entext}</Text>}
                                <HeroBtnGroup>
                ...
                <Container>
                    <Row>
                        <Col lg={12}>
                            <HeroContent>
                                {ensubtitle && <Heading {...subtitleStyle}>{ensubtitle}</Heading>}
                                {entitle && <Heading {...titleStyle}>{entitle_tht}</Heading>}
                                {entext && <Text {...textStyle}>{entext}</Text>}
                                <HeroBtnGroup>
                                    {link && <Button {...btnStyle} {...consult_btn}>Find out more...</Button>}
                ...
                <Container>
                    <Row>
                        <Col lg={12}>
                            <HeroContent>
                                {ensubtitle && <Heading {...subtitleStyle}>{ensubtitle}</Heading>}
                                {entitle && <Heading {...titleStyle}>{entitle_clean}</Heading>}
                                {entext && <Text {...textStyle}>{entext}</Text>}
                                <HeroBtnGroup>
                                    {link && <Button {...btnStyle} {...consult_btn}>Find out more...</Button>}
                ...
                <Container>
                    <Row>
                        <Col lg={12}>
                            <HeroContent>
                                {ensubtitle && <Heading {...subtitleStyle}>{ensubtitle}</Heading>}
                                {entitle && <Heading {...titleStyle}>{entitle_coating}</Heading>}
                                {entext && <Text {...textStyle}>{entext}</Text>}
                                <HeroBtnGroup>
                                    {link && <Button {...btnStyle} {...consult_btn}>Find out more...</Button>}
                ...
                <Container>
                    <Row>
                        <Col lg={12}>
                            <HeroContent>
                                {ensubtitle && <Heading {...subtitleStyle}>{ensubtitle}</Heading>}
                                {entitle && <Heading {...titleStyle}>{entitle_aoi}</Heading>}
                                {entext && <Text {...textStyle}>{entext}</Text>}
                                <HeroBtnGroup>
                                    {link && <Button {...btnStyle} {...consult_btn}>Find out more...</Button>}
