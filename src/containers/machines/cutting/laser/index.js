...
const CaseStudiesArea = (props) => {
    const autoPrinterData = useStaticQuery(graphql `
        query {
            allMachineJson (filter: {id: {regex: "/separation-laser/"}}, sort: {order: ASC, fields: id}) {
                edges {
                    node {
                        fields{
                            slug
            ...
            allMachineUaJson (filter: {id: {regex: "/separation-laser/"}}, sort: {order: ASC, fields: id}) {
                edges {
                    node {
                        fields{
                            slug
        ...
        <Section {...sectionStyle}>
            <Row>
                ...
                <br></br>
                    ...
                    <h6 style={{textAlign: "justify"}}>
                    Лазерне різання - це сучасний метод розділення групових заготовок друкованих плат. Процес рекомендується для електронних плат, які мають складний контур, вироби на гнучких платах. Машини незамінні при виробництві електроніки для сучасної портативної техніки, розумного одягу, смартфонів та інших гаджетів.</h6>
