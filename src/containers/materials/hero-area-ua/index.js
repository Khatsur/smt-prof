...
const HeroArea = (props) => {
    ...
    `);
    const {uatitle, title_tht, title_coating, subtitle, text_solder, text_clean, text_coating, bg_image, bg_image2, bg_image4, link, video_link} = heroData.indexResolutionsJson;
                ...
                <Container>
                    <Row>
                        <Col lg={12}>
                            <HeroContent>
                                {subtitle && <Heading {...subtitleStyle}>{subtitle}</Heading>}
                                {title_tht && <Heading {...titleStyle}>{title_tht}</Heading>}
                ...
                <Container>
                    <Row>
                        <Col lg={12}>
                            <HeroContent>
                                {subtitle && <Heading {...subtitleStyle}>{subtitle}</Heading>}
                                {title_coating && <Heading {...titleStyle}>{title_coating}</Heading>}
