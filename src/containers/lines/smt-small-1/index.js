...
const CaseStudySection = ({
    ...
    query LineSmtSmall1Query {
        indexLinesJson(id: {eq: "smt-small-1"}) {
            id
            title
            subtitle
            uatitle
        ...
        allMachineJson (filter: {id: {regex: "/spide-sd300|manipulator-lm900|spide-ha06/"}}, sort: {fields: line, order: ASC}, limit: 5) {
            edges {
                node {
                    ru
                    id
        ...
        allMachineUaJson (filter: {id: {regex: "/spide-sd300|manipulator-lm900|spide-ha06/"}}, sort: {fields: line, order: ASC}, limit: 5) {
            edges {
                node {
                    ua
                    id
