...
const CaseStudySection = ({
    ...
    query LineCoatingIrQuery {
        indexLinesJson(id: {eq: "coating-ir"}) {
            id
            title
            subtitle
            uatitle
        ...
        allMachineJson (filter: {id: {regex: "/selective-delta-6|cycc460|deltatherm/"}}, sort: {fields: line, order: ASC}, limit: 5) {
            edges {
                node {
                    ru
                    id
        ...
        allMachineUaJson (filter: {id: {regex: "/selective-delta-6|cycc460|deltatherm/"}}, sort: {fields: line, order: ASC}, limit: 5) {
            edges {
                node {
                    ua
                    id
