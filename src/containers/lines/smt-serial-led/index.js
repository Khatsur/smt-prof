...
const CaseStudySection = ({
    ...
    query LineSmtSerialLedQuery {
        indexLinesJson(id: {eq: "smt-serial-led"}) {
            id
            title
            subtitle
            uatitle
        ...
        allMachineJson (filter: {id: {regex: "/pmaxii|rs-1xl|conveyer-mb|juki-rs-1000|loader-mb817/"}}, sort: {fields: line, order: ASC}, limit: 13) {
            edges {
                node {
                    ru
                    id
        ...
        allMachineUaJson (filter: {id: {regex: "/pmaxii|rs-1xl|conveyer-mb|juki-rs-1000|loader-mb817/"}}, sort: {fields: line, order: ASC}, limit: 13) {
            edges {
                node {
                    ua
                    id
