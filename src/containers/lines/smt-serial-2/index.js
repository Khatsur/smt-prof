...
const CaseStudySection = ({
    ...
    query LineSmtSerial2Query {
        indexLinesJson(id: {eq: "smt-serial-2"}) {
            id
            title
            subtitle
            uatitle
        ...
        allMachineJson (filter: {id: {regex: "/loader-mb801|g-titan|juki-rs-1r|placer-juki-rs-11|conveyer-lc|juki-rs-800|aoi-rv-2-3d1|loader-mb802/"}}, sort: {fields: line, order: ASC}, limit: 10) {
            edges {
                node {
                    ru
                    id
