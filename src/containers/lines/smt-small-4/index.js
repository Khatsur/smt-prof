...
const CaseStudySection = ({
    ...
    query LineSmtSmal41Query {
        indexLinesJson(id: {eq: "smt-small-4"}) {
            id
            title
            subtitle
            uatitle
        ...
        allMachineJson (filter: {id: {regex: "/kayo-50p|kayo-450|kayo-a8l|kayo-ic|rf-630|kayo-50s/"}}, sort: {fields: line, order: ASC}, limit: 7) {
            edges {
                node {
                    ru
                    id
        ...
        allMachineUaJson (filter: {id: {regex: "/kayo-50p|kayo-450|kayo-a8l|kayo-ic|rf-630|kayo-50s/"}}, sort: {fields: line, order: ASC}, limit: 7) {
            edges {
                node {
                    ua
                    id
