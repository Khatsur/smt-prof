...
const CaseStudySection = ({
    ...
    query LineCoatingDipQuery {
        indexLinesJson(id: {eq: "coating-dip"}) {
            id
            title
            subtitle
            uatitle
        ...
        allMachineJson (filter: {id: {regex: "/knodel/"}}, sort: {order: ASC, fields: id}, limit: 5) {
            edges {
                node {
                    ru
                    id
        ...
        allMachineUaJson (filter: {id: {regex: "/knodel/"}}, sort: {order: ASC, fields: id}, limit: 5) {
            edges {
                node {
                    ua
                    id
