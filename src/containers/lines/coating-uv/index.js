...
const CaseStudySection = ({
    ...
    query LineCoatingUvQuery {
        indexLinesJson(id: {eq: "coating-uv"}) {
            id
            title
            subtitle
            uatitle
        ...
        allMachineJson (filter: {id: {regex: "/selective-delta-6|cycc460|spectra/"}}, sort: {fields: line, order: ASC}, limit: 5) {
            edges {
                node {
                    ru
                    id
        ...
        allMachineUaJson (filter: {id: {regex: "/selective-delta-6|cycc460|spectra/"}}, sort: {fields: line, order: ASC}, limit: 5) {
            edges {
                node {
                    ua
                    id
