...
const CaseStudySection = ({
    ...
    query LineSmtStorageQuery {
        indexLinesJson(id: {eq: "storage-1"}) {
            id
            title
            subtitle
            uatitle
        ...
        allMachineJson (filter: {id: {regex: "/material-incomin-station|ultraflex-3600/"}}, sort: {fields: line, order: ASC}, limit: 5) {
            edges {
                node {
                    ru
                    id
        ...
        allMachineUaJson (filter: {id: {regex: "/material-incomin-station|ultraflex-3600/"}}, sort: {fields: line, order: ASC}, limit: 5) {
            edges {
                node {
                    ua
                    id
