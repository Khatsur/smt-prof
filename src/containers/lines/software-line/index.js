...
const CaseStudySection = ({
    ...
    query LineSoftwareQuery {
        indexLinesJson(id: {eq: "software-1"}) {
            id
            title
            subtitle
            uatitle
        ...
        allMachineJson (filter: {id: {regex: "/juki-janets|juki-trace-monitor|juki-ifs-nx/"}}, sort: {fields: line, order: ASC}, limit: 5) {
            edges {
                node {
                    ru
                    id
        ...
        allMachineUaJson (filter: {id: {regex: "/juki-janets|juki-trace-monitor|juki-ifs-nx/"}}, sort: {fields: line, order: ASC}, limit: 5) {
            edges {
                node {
                    ua
                    id
                ...
                <Row style={{marginLeft: "10px", marginRight: "10px", "fontSize": "16px"}}>
                  <Col lg={12}>
                      ...
                      <ul style={{listStyleType: "none", marginLeft: "17px"}}>
                        <li style={{color: "#086AD8", fontWeight: "bold", textTransform: "uppercase"}}>Спецификация:</li>
            ...
            <Container>
                ...
                <Row style={{marginLeft: "10px", marginRight: "10px", "fontSize": "16px"}}>
                  <Col lg={12}>
                      ...
                      <ul style={{listStyleType: "none", marginLeft: "17px"}}>
                        <li style={{color: "#086AD8", fontWeight: "bold", textTransform: "uppercase"}}>Специфікація:</li>
