...
const HeroArea = (props) => {
    const heroData = useStaticQuery(graphql `
        query ServiceQueryEn {
            indexResolutionsJson(id: {eq: "service-content"}) {
                entitle
                entitle_tht
                entitle_clean
                entitle_coating
    ...
    `);
    const {entitle, entitle_tht, entitle_coating, ensubtitle, entext_solder, entext_clean, entext_coating, bg_image, bg_image2, bg_image4, link, video_link} = heroData.indexResolutionsJson;
