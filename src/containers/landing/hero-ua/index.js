...
import { Language } from '../../../components/language-ua/index'
                ...
                <Row className="align-items-center h-100">
                    <Col lg={6}>
                        <HeroWrapperText>
                            ...
                            <Button {...buttonStyle} to={'https://www.youtube.com/watch?v=HRDLsJPvt6A'} rel="noopener noreferrer" target="_blank">ДЕМО-ВІДЕО</Button>
                        </HeroWrapperText>
                    </Col>
                    <Col lg={6}>
                        <PreviewInnerImg>
