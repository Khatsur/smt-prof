    ...
    <HeroWrapper fluid={bgImage.childImageSharp.fluid}>
      <Container fluid className="xp-150">
          ...
          <Col lg={6}>
            <PreviewInnerImg>
              <Img
                ...
                className="img-fluid min-img animation_images one wow fadeInDown"
                alt="Preview Hero"
              />
            </PreviewInnerImg>
          </Col>
        ...
        <Img
          ...
          className="img-fluid pr-img-01 animation_images two wow fadeInDown"
          alt="Preview Hero"
        />
        <Img
          fluid={image3.childImageSharp.fluid}
          className="img-fluid pr-img-02 animation_images two wow fadeInDown"
          alt="Preview Hero"
        />
        <Img
          fluid={image4.childImageSharp.fluid}
          className="img-fluid pr-img-03 animation_images two wow fadeInDown"
          alt="Preview Hero"
        />
      </Container>
    </HeroWrapper>
